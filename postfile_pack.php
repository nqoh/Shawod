...
if(isset($_POST['name'])  && isset($_POST['contact'])  && isset($_POST['text'])){
    ...
    $date=date("Y/m/d") ;
	  ...
	  if(mysqli_num_rows($chek)== 0) {
          $save = mysqli_query($conn, "INSERT INTO `not_approved` VALUES(null, '$nam', '$lnam','$email', '$cont', '$txt', '$pack', '$feature', '$ref', '$user_id','$pass1','', $a, '$price','$discount' ,'', CURRENT_TIMESTAMP)");
...
<img src="http://shawod.co.za/thumbnails/logoSb.png" style="float: right; margin-top: -50px"></div>
        ...
        //  echo "Your reference is <b style='color: rgb(51,204,255)'>" . $ref . "</b> please save it<br><br> Thank you " . $nam . " we will get back to you soon";
      }else{
	      echo "You are already a client, order new services on Portal";
      }
}
