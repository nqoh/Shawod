...
if(isset($_SESSION['uname']) && $_SESSION['id']) {
    ...
    if ($row = mysqli_fetch_assoc($query)) {
        ...
        $file=$row['file_name'];
        $src='';
        if($file=="undefined"){$src="";}else{$src="<br><img style='margin-left: 10px; display:block;' id='images12' width='350px' src='http://shawod.co.za/img/$file'>";}
        if($img == 1){
        ...
        while($row2=mysqli_fetch_assoc($query2)){
            if($x > 0 && $x < $total-1) {
                ...
                $src2='';
                if($file2=="undefined"){$src2="";}else{$src2="<br><img style='margin-left: 10px; display:block;' id='images22' width='350px' src='http://shawod.co.za/img/$file2'>";}
                $text2 = $row2['text'];
        ...
        $src3='';
        if($file3=="undefined"){$src3="";}else{$src3="<br><img style='margin-left: 10px; display:none;' id='images2' width='350px' src='http://shawod.co.za/img/$file3'>";}
        ...
        if(mysqli_num_rows($query3) == 1){
            $msg2 =" <div><p class=\"bill\"><u>Developers Department</u></p><p class=\"sub\" style='font-size: 20px'>$sub</p><br><p style=\"margin-left:25px; font-size:18px;\">
                ...
                <span id=\"view2\" class='view' onmouseup=\"img_dsp('images2')\" onClick=\"opens('view2', 'prev2', 'reply2','pre_ms2',$myid,'developer')\">View</span>$src3</p>
                <div id=\"reply2\" style=\"width:100%; height:100px; margin-left:30px; display:none\"><span id=\"status\" style=\"color:red;\"></span><br>
                <input type=\"text\" id=\"text_input2\" class='text_input'><br><input type=\"file\" class='file' id=\"file2\" onchange=\"add_file('file2','filename3')\"><div class=\"photo\">Attach a snapshot</div>
                ...
                <button id=\"rp\" onmouseup=\"upload_file('file2')\"   onclick=\"replys('view2', 'prev2', 'reply2','pre_ms2',$myid,'developer','text_input2','file2','developer')\">Reply</button><br><span id=\"filename3\"></span></div></p></div>";
            ...
            $msg2 = " <div><p class=\"bill\"><u>Developer Department</u></p><p class=\"sub\" style='font-weight: bold; '>$sub</p><br><p style=\"margin-left:25px; font-size:18px;\">
                ...
                <span id=\"view2\" class='view'  onmouseup=\"img_dsp('images2')\"  onClick=\"opens('view2', 'prev2', 'reply2','pre_ms2',$myid,'developer')\">View</span>$src3<br><br></p>
...
if(isset($_FILES["file"]["name"])){
    ...
    move_uploaded_file($fileTmpLoc, "http://shawod.co.za/img/$fileName");
}