...
if(isset($_SESSION['uname']) && $_SESSION['id']) {
    ...
    if ($row = mysqli_fetch_assoc($query)) {
        ...
        $file=$row['file_name'];
        $src='';
        if($file=="undefined"){$src="";}else{$src="<br><img style='margin-left: 10px; display:block;' id='images14' width='350px' src='http://shawod.co.za/img/$file'>";}
        if($img == 1){
        ...
        while($row2=mysqli_fetch_assoc($query2)){
            if($x > 0 && $x < $total-1) {
                ...
                $src2='';
                if($file2=="undefined"){$src2="";}else{$src2="<br><img style='margin-left: 10px; display:block;' id='images24' width='350px' src='http://shawod.co.za/img/$file2'>";}
        ...
        $src3='';
        if($file3=="undefined"){$src3="";}else{$src3="<br><img style='margin-left: 10px; display:block;' id='images5' width='350px' src='http://shawod.co.za/img/$file3'>";}
        ...
        if(mysqli_num_rows($query3) == 1){
            $msg4 =" <div><p class=\"bill\"><u>Other Department</u></p><p class=\"sub\" style='font-size: 20px'>$sub</p><br><p style=\"margin-left:25px; font-size:18px;\">
                ...
                <input type=\"text\" id=\"text_input4\" class='text_input'><br><input type=\"file\" class='file' id=\"file4\" onchange=\"add_file('file4','filename4')\"><div class=\"photo\">Attach a snapshot</div>
                ...
                <button id=\"rp\" onmouseup=\"upload_file('file4')\"   onclick=\"replys('view4', 'prev4', 'reply4','pre_ms4',$myid,'other','text_input4','file4','other')\">Reply</button><br><span id=\"filename4\"></span></div></p></div>";
            ...
            $msg4 = " <div><p class=\"bill\"><u>Hosting Department</u></p><p class=\"sub\" style='font-weight: bold; '>$sub</p><br><p style=\"margin-left:25px; font-size:18px;\">
                ...
                <button id=\"rp\" onmouseup=\"upload_file('file4')\"  onclick=\"replys('view4', 'prev4', 'reply3','pre_ms3',$myid,'other','text_input4','file4','other')\">Reply</button><br><span id=\"filename4\"></span></div></p></div>";
        }
    }
