...
<ul>
  ...
  <li class="bg"><a href="../projects" style="color: white">Projects</a></li>
...
<div class="content">
   <h1 align="center" id="pj" style="margin-left: 120px">Projects</h1>
    <div id="preview3">
        ...
        <div id="frame1">
        <iframe src="http://shawod.co.za/client_project/<?php echo $folder ?>" width="900px" style="margin-left: 85px" height="400px" ></iframe>
        <div style="margin-left: 50px"><a style="margin-left: 50px;" target = '_blank' href="http://shawod.co.za/client_project/<?php echo $folder ?>"><img src="http://shawod.co.za/thumbnails/view.png"></a> <?php echo $web  ?></div></div>

       <div id="frame2" style="margin-left: 85px; display: none" >
        <iframe src="http://shawod.co.za/client_project/logos/<?php echo $folder ?>/nologo.jpg" width="900px" height="400px"  ></iframe>
        <div style="margin-left: -40px"><?php echo $log  ?></div></div>

        <div id="frame3" style="margin-left: 85px ; display:none;">
        <iframe src="http://shawod.co.za/client_project/cms/<?php echo $folder ?>/nocms.jpg" width="900px" height="400px"  ></iframe>
            <div style="margin-left: -40px"><?php echo $cms  ?></div></div>
        </div>
    </div>

<!-- starting the chat div  --->

        <!---
            <div  style="display:block" id="prev">
        <p style="margin-left:40px;margin-bottom:-35px;font-size:13px; color:rgb(109,109,109)"> 21 march | 07:08 am </p><br>
        <p style="margin-left:30px">Wow tha was caoused by server migrations</p>
    </div>

    <p style="margin-left:40px;margin-bottom:-35px;font-size:13px; color:rgb(109,109,109)"> 21 march | 07:08 am </p><br>
    <p style="margin-left: 30px">Your paymantes are de next week please don't claim glory days  lool blaaaa
        blaaaa blaa blahh blhgvjh kjughjbjnbjbjmn  mbjhkbhuj jughujb uygyugbnb <span id="view" onClick="opens()">View</span> </p>
    <div id="reply" style="width:100%; height:100px; margin-left:30px; display:block">
        <span id="status" style="color:red;"></span>
        <input type="text" class="text_input">
        <button id="rp">Reply</button><br>

        <span id="filename"> Errror </span>
    </div>
     ...
     <div id="terms2" style="padding-left: 50px ;display: none ;width: 1100px; margin-left: 150px">
     ...
     <div style="padding-left: 50px; display: none;width: 1100px; margin-left: 150px" id="privacy2">
