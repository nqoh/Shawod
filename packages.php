...
<head>
  ...
  <link href="css/abow.css" rel="stylesheet">
    ...
    }.pricing-palden .pricing-deco {background: #fff;}.pricing-palden .pricing-title {color: #33ccff;} 
.pricing-palden .pricing-action:hover {box-shadow: inset 0 -2.25em 0 0 var(--hover); -webkit-box-shadow: inset 0 -2.25em 0 0 var(--hover);transition: 0.55s;}
.pricing-action { --hover: #fff;} .single-service, .single-service-2, .single-service-3 {margin: 15px 0; margin-right: 50px;} </style>
<meta name="title" content="Packages | Shawod">
...
<meta name="robots" content="index/follow">
    ...
    <meta property="og:url" content="https://shawod.co.za/packages.php">
...
<meta property="twitter:url" content="https://shawod.co.za/packages.php">
...
--><script>
    function getpack(pckname,bnfit1,bnfit2,bnfit3,price,img,bnfit4,bnfit5,bnfit6,bnfit7,bnfit8,status,bnfit9,pg) {
        ...
        window.location="getstartedpack"
    }
</script><body>
<div id='easy-top'></div>
	<header id="header">      
                ...
                <div class="row">
                    <div class="action">
                        <div class="col-sm-12">
                            ...
                            <p>Choose your package. &nbsp; <i class="fa fa-cart-plus" ></i></p>
                        </div>
                     </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="clients text-center wow fadeInUp" data-wow-duration="500ms" data-wow-delay="300ms">
                        <h1> Let's develop your <span class="typewrite" style="color:rgb(51,204,255)" data-period="100000" data-type='[ "Stunning", "Premium" ]' ></span>
      </a> Website.
</h1>
                    </div>
                </div>
  ...
  <div class='pricing pricing-palden'>
    <div class='pricing-item'>
      <div class='pricing-deco'><div class="angazi"><img src="images/home/S-bronze.png" alt=""></div>
        ...
        <div class='pricing-price'><span class='pricing-currency'>R</span>4 499.00
      ...
      </ul><span onclick="getpack('Bronz Pack','3 Pages','General Design','Express website','4499.00',
            'images/home/S-bronze.png','1 month free economy hosting','Free Domain','','','',
            'With the Bronze package you can be a proud owner of a website quickly','','package')"
                 class="btn pricing-action"><CENTER>Configure</CENTER></span>
    </div>
    <div class='pricing-item pricing__item--featured'>
      <div class='pricing-deco'> <div class="angazi"><img src="images/home/S-silver.png" alt=""></div>
        ...
        <div class='pricing-price'><span class='pricing-currency'>R</span>6 749.99
          
        </div>
        <h3 class='pricing-title'>Silver Pack</h3>
      </div> <div class="angazisp"><img src="images/home/popular13.png" alt="POPULAR"></div>
      <ul class='pricing-feature-list'>
      ...
      </ul><span class="btn pricing-action" onclick="getpack('Silver Pack','5 Pages','1 Contact Form','Social Media Integration','6749.99',
            'images/home/S-silver.png', '1 Month Free Economy Host','Free Domain','Premium Design','','',
            'The Silver package is fully loaded with common features, and is preferred by most of our clients.','','package')"><CENTER>Configure</CENTER></span>
    </div>
    <div class='pricing-item'>
      <div class='pricing-deco'><div class="angazi"><img src="images/home/S-gold.png" alt=""></div>
        ...
        <div class='pricing-price'><span class='pricing-currency'>R</span>10 199.99
         <!-- <span class='pricing-period'>/ mo</span> -->
        </div>
      ...
      </ul><span class="btn pricing-action" onclick="getpack('Gold Pack','8 Pages','2 Month Free Economy Hosting ','5 Webmail Account','10199.99',
            'images/home/S-gold.png','Social Media Integration','Custom Design','1 Free Domain','1 Contact Form','2*5 Photo Gallery',
             ...
             <div class="row">
                <div class="col-sm-4 text-center padding wow fadeIn" data-wow-duration="1000ms" data-wow-delay="300ms">
                   <ul> <div class="single-service">
                        ...
                        <h2>Bronze Pack</h2>
                        <span>With the Bronze package you can be a proud owner of a website quickly on a low budget, for individuals expecting low traffic.</span>
                ...
                <div class="col-sm-4 text-center padding wow fadeIn" data-wow-duration="1000ms" data-wow-delay="600ms">
                   <ul> <div class="single-service">
                        ...
                        <h2>Silver Pack</h2>
                        <p>The Silver package is fully loaded with common features, and is preferred by most of our clients.</p>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="clients text-center wow fadeInUp" data-wow-duration="500ms" data-wow-delay="300ms">
                        ...
                        <p>Owning one of these Premium packages means you never have to worry about traffic crashing your Website, Storage, and online Security threats.</p>
                    </div>
                </div>
            </div>
  ...
  <div class='pricing pricing-palden'>
    <div class='pricing-item' style='margin: 1em 0.6em;'>
      <div class='pricing-deco'>
        ...
        <div class='pricing-price'><span class='pricing-currency'>R</span>17 850.00
         <!-- <span class='pricing-period'>/ mo</span> -->
        </div>
      ...
      <ul class='pricing-feature-list'>
        ...
        <span class="btn pricing-action" onclick="getpack('Platinum Pack','10 Pages','Dulux Hosting ','Premium Design','17850.00',
            'images/home/prem.png','Social Media Integration','2*5 Photo Gallery','1 Free Domain','1 Contact Form','1*5 Email Account',
    ...
    <div class='pricing-item pricing-palden'>
      <div class='pricing-deco'>
        ...
        <div class='pricing-price'><span class='pricing-currency'>R</span>23 000.00
      ...
      </ul><span class="btn pricing-action" onclick="getpack('Diamond Pack','15 Pages','10 Free Emails Account','Dulux Hosting 1Month','23000.00',
            'images/home/prof.png','3*5 Photo Gallery','Premium Design','1 Free Domain','1 Contact Form','Premium S.E.O',
    ...
    <div class='pricing-item' style='margin: 1em 0.6em;'>
      <div class='pricing-deco'>
        ...
        <div class='pricing-price'><span class='pricing-currency'>R</span>26 500.00
         <!-- <span class='pricing-period'>/ mo</span> -->
        </div>
      ...
      <ul class='pricing-feature-list'>
        ...
        <span class="btn pricing-action" onclick="getpack('Titanium Pack','20 Pages','15 Emails Account ','Professional S.E.O','26500.00',
            'images/home/ulti.png','Privacy Protection','Custom Design','1 Free Domain','1 Contact Form','4*5 Photo Gallery',
...
<div class="container">
  ...
  <p>These high-end websites are highly appreciated by large corporations and highly trafficked websites alike, get one and be part of the Shawod elite members.</p>
                    </div>
                </div>
            </div>
  ...
  <br><br><br>
    <!--/#team-->
<div id="coupon_alert" style="width:0%; padding: 2%;background:#33ccff;border:2px solid white;border-left: none; border-right: none;position:fixed;z-index:200;top:83%;">
    <p align="center" id="label" style="display:none;color:white;font-size: 150%; border-radius:10%;border: 2px solid  #33ccff">Use this coupon <span style="padding: 0.1% 0% 0% 0.5%;color: #33ccff; background: white">
        <?php echo $copon ?>
    </span>&nbsp; to get <?php echo $discount ?>% discount on any package <span onclick="closeCoupon()" class="btn pricing-action" style="float:right;background: white;color:#33ccff">OK</span></p>
</div>
