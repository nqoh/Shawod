...
if(isset( $_SESSION['id'])) {
    $myid = $_SESSION['id'];
        ...
        $file=$row['file_name'];
        $src='';
        if($file=="undefined"){$src="";}else{$src="<br><img style='margin-left: 10px; display:block;' id='images13' width='350px' src='../../img/$file'>";}
        if($img == 1){
        ...
        while($row2=mysqli_fetch_assoc($query2)){
            if($x > 0 && $x < $total-1) {
                ...
                $src2='';
                if($file2=="undefined"){$src2="";}else{$src2="<br><img style='margin-left: 10px; display:block;' id='images23' width='350px' src='../../img/$file2'>";}
        ...
        $src3='';
        if($file3=="undefined"){$src3="";}else{$src3="<br><img style='margin-left: 10px; display:none;' id='images4' width='350px' src='../../img/$file3'>";}
        ...
        if(mysqli_num_rows($query3) == 1){
            $msg3 =" <div><p class=\"bill\"><u>Hosting Department</u></p><p class=\"sub\" style='font-size: 20px'>$sub</p><br><p style=\"margin-left:25px; font-size:18px;\">
                ...
                <span id=\"view3\" class='view' onmouseup=\"img_dsp('images4')\" onClick=\"opensx('view3', 'prev3', 'reply3','pre_ms3',$myid,'hosting')\">View</span>$src3</p>
                <div id=\"reply3\" style=\"width:100%; height:100px; margin-left:30px; display:none\"><span id=\"status\" style=\"color:red;\"></span><br>
                <input type=\"text\" id=\"text_input3\" class='text_input'><br><input type=\"file\" class='file' id=\"file3\" onchange=\"add_file('file3','filename3')\"><div class=\"photo\">Attach a snapshot</div>
                ...
                <button id=\"rp\" onmouseup=\"upload_file('file3')\"   onclick=\"replys('view3', 'prev3', 'reply3','pre_ms3',$myid,'hosting','text_input3','file3','hosting')\">Reply</button><br><span id=\"filename3\"></span></div></p></div>";
            ...
            $msg3 = " <div><p class=\"bill\"><u>Hosting Department</u></p><p class=\"sub\" style='font-weight: bold; '>$sub</p><br><p style=\"margin-left:25px; font-size:18px;\">
                ...
                <span id=\"view3\" class='view'  onmouseup=\"img_dsp('images4')\"  onClick=\"opensx('view3', 'prev3', 'reply3','pre_ms3',$myid,'hosting')\">View</span>$src3<br><br></p>
