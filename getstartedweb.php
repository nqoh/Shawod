...
<head>
    ...
    <title>Configure website | Shawod</title>
            ...
            <div class="row">
                <div class="action">
                    <div class="col-sm-12">
                        ...
                        <p>Configure your website. &nbsp; <i class="fa fa-cart-plus" ></i></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="clients text-center wow fadeInUp" data-wow-duration="500ms" data-wow-delay="300ms">
                    ...
                    <p> Gather everything you need and see how much it costs, Shawod make sure you save.
                    </p>
                </div>
            </div>
        </div>
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            ...
            <div class="live-preview">
                <a href="websites.php" class="btn btn-common uppercase">Change</a>
            </div>
        </div>
    </div>
    ...
    <span>
        ...
        <span id="ssls"><b>S S L Certificate</b> (R1300.00 p/a)</span>
         <i class="fa fa-question-circle" id="six"></i>
    </span>
        </p>-->
...
<!--
    ...
    <span>
        ...
        <span id="protect"><b>Protected Protection</b> (R349.99 first year , R699.99 renewal p/a)</span>
         <i class="fa fa-question-circle" id="six"></i>
    </span>
        </p>-->
    ...
    <div style="float: right; display: none;  margin-right: 40px;">
        <p style="margin: 0px 0px 20px 0px">
    <span>
    ...
    <span>
        ...
        <span id="e_host"><b>Duluxe Hosting</b> (30% off first month , R79.99 renewal p/m)</span>
         <i class="fa fa-question-circle" id="six"></i>
    </span>
        </p>
    ...
    <span>
        ...
        <span id="e_host"><b>Premium Hosting</b> (35% off first month , R119.99 renewal p/m)</span>
         <i class="fa fa-question-circle" id="six"></i>
    </span>
        </p>
        <br>
...
<script src="js/from_validation2.js"></script>
</body>
</html>
