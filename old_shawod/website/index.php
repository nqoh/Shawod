...
if ($tablet_browser > 0) {
    ...
    header('Location: https://mobi.shawod.co.za/website');
    exit();
}
else if ($mobile_browser > 0) {
    // do something for mobile devices

    header('Location: https://m.shawod.co.za/website');
    exit();
...
<div class="navs">
    <ul>
        ...
        <div class="dv"></div>
        <li><a href="../website" style="color: rgb(140,140,140); margin-left:-20%" >Website</a></li>
...
<h2 align="center" class="popula_hd"><u>Welcome to Shawod where your imagination becomes a reality</u></h2>
...
<div class="discribe_div">
    <p style="color:rgb(255,255,255); font-size: 20px"><img src="thumbnails/S-bronze.png" style="float: left; width: 20px"><p style="color: white; font-size: 20px"><b style="font-size: 23px;color:rgb(51,204,255)">Bronze Web - </b>
        With the Bronze package you can be a proud owner of a website quickly on a low budget<br>
        &emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; recommended for individuals expecting low traffic.</br>
    ...
    <p style="color:rgb(255,255,255); font-size: 20px"><img src="thumbnails/S-silver.png" style="float: left; width: 20px"><p style="color: white; font-size: 20px"><b style="font-size: 23px;color: rgb(51,204,255)">Silver Web - </b>
    ...
    <p style="color:rgb(255,255,255); font-size: 20px"><img src="thumbnails/S-gold.png" style="float: left; width: 20px"><p style="color: white; font-size: 20px"><b style="font-size: 23px;color: rgb(51,204,255)">Gold Web - </b>
...
<h2 align="center" class="popula_hd"><u>Wanna Join the Big League?</u></h2>
...
<div class="discribe_div">
    <p style="color:rgb(255,255,255); ">
        <span class="text">These high-end websites are highly
...
<img src="thumbnails/web-dev.png" align="center" style="margin-left: 500px">
