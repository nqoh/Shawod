...
if ($tablet_browser > 0) {
    ...
    header('Location: https://mobi.shawod.co.za/website/started');
    exit();
}
else if ($mobile_browser > 0) {
    // do something for mobile devices

    header('Location: https://m.shawod.co.za/website/started');
    exit();
...
<div style="width: 1200px; padding-left: 70px">
    <div>
...
<p id="list">
    ...
    <span id="ssls" >S S L Certificate (R1300.00) </span>
</p>
...
<p id="list">
    ...
    <span id="protect" > Protected Registration (R349.99 first month , R699.99 renewal p/a) </span>
</p>
...
<p id="list">
    ...
    <span id="domains" > Domain Infor.Locker (R200.00) </span>
</p>-->
...
<div style="float: right; margin-top: -530px; margin-right: 40px;">
    ...
    <p id="list" style="margin-right: 35px">
        ...
        <span id="p_host" >  Premium Hosting (30% off first month , R79.99 renewal p/m) </span>
    </p>
    <p id="list" style="margin-right: 35px">
        ...
        <span id="g_host" >  Gold Hosting (35% off first month , R119.99 renewal p/m) </span>
    </p>
...
<br>
    ...
    <p id="list" style="margin-right: 35px">
        ...
        <span id="g_seo" >  Basic S.E.O (R420.00 p/a) </span>
    </p>
    ...
    <p id="list" style="margin-right: 35px">
        ...
        <span id="p_seo" >  Premium S.E.O (R660.00 p/a) </span>
    </p>
    <p id="list" style="margin-right: 35px">
        ...
        <span id="c_seo" >  Gold S.E.O(999.99 p/a) </span>
    </p>
</div>
-->
    <!---
...
<p id="list" style=" ">
   <input type="radio" value="economy"  name="radios">Economy Hosting (Free first month , R50.00 renewal p/m)<br><br>
    <input type="radio" value="premium" name="radios">Premium Hosting (10% off first month , R75.00 renewal p/m)<br><br>
    <input type="radio" value="gold" name="radios">Gold Hosting (8% off first month , R120.00 renewal p/m)<br><br>
</p>

<p id="list" style=";  margin-right: 355px">
    <input type="radio" value="economy"  name="design">General Design (R49.89)<br><br>
    <input type="radio" value="premium" name="design"> Premium Design (R69.95)<br><br>
    <input type="radio" value="gold" name="design">Custom Design (R99.99 )<br><br>
</p>

<p id="list" style="  margin-right: 320px">
    <input type="radio" value="economy"  name="seo">Basic S.E.O (R420.00 p/a)<br><br>
    <input type="radio" value="premium" name="seo"> Premium S.E.O (R660.00 p/a)<br><br>
    <input type="radio" value="gold" name="seo">Gold S.E.O(999.99 p/a)</p>
</p>--->
</div>
...
<div id="t_div">
    ...
    <tr>
        <td>1</td>
        <td>Search Engen Optimization</td>
        <td>1*5</td>
        <td>R 300.00</td>
        <td>Gold Package</td>
