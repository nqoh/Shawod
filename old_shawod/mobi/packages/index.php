...
<div class="navs">
    <ul>
        ...
        <div class="dv"></div>
        <li ><a href="../packages" style=" opacity:1;color: rgb(140,140,140)"> Packages</a>
        </li>
...
<h3 align="center" class="popula_hd" style="font-size: 26px"><u>We have made comprehensive packages to suit you</u></h3>
...
<div class="discribe_div">
    ...
    <p style="color:rgb(255,255,255); "><img src="thumbnails/S-bronze.png" style="float: left; width: 20px; font-size: 22px"><p style="color: white;font-size: 22px;"><b style="font-size: 26px;color: rgb(51,204,255);">Bronze pack - </b>
        With the Bronze package you can be a proud owner of a website quickly &nbsp;on a low budget,for individuals expecting low traffic.<br>
    ...
    <p style="color:rgb(255,255,255);"><img  src="thumbnails/S-gold.png" style="float: left; width: 20px"><p style="color: white;font-size: 22px;"><b style="font-size: 26px;color: rgb(51,204,255)">Gold pack - </b>
        ...
        &emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;<span class="gold_price"><b>*</b>8 Pages </span><br>
        &emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;<span class="gold_price"><b>*</b>2 Month Free Hosting </span><br>
        &emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;<span class="gold_price"><b>*</b>Basic S.E.O</span><br>
    </p>
    </p>
...
<h3 align="center" class="popula_hd"><u style="font-size: 26px">If that wasn't enough Have a Look at our High-end packages preferred by enterprises and trafficked website alike </u></h3>
...
<div class="discribe_div">
    ...
    <p style="color:rgb(255,255,255);"><p style="color: white;font-size: 24px ">
...
<img src="thumbnails/S-trolley2.png"  style="margin-left: -25%; width: 150%">
