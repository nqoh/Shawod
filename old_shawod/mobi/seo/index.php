...
<div class="navs">
    <ul>
        ...
        <div class="dv"></div>
        <li><a href="../seo" style=" opacity:1;color: rgb(140,140,140)" >SEO</a></li>
        <div class="dv"></div>
...
<div align="center" style="width: 90%; margin-left: 5%">
    ...
    <p align="left" style="color: white;opacity: .6;font-size: 22px">
    ...
    <h2 align="left" style="color: white;"><u>Basic S E O</u></h2>
    <p align="left" style="color: white; opacity: .6;font-size: 22px"><b>.</b> Off-page SEO</p>
    <p align="left" style="color: white; opacity: .6;font-size: 22px"><b>.</b> Robots</p>
    <p align="left" style="color: white; opacity: .6;font-size: 22px"><b>.</b> Sitemap</p>

    <h2 align="left" style="color: white; "><u>Premium S E O</u></h2>
    <p align="left" style="color: white; opacity: .6;font-size: 22px"><b>.</b> keywords</p>
    <p align="left" style="color: white; opacity: .6;font-size: 22px"><b>.</b> Metatags</p>
    <p align="left" style="color: white; opacity: .6;font-size: 22px"><b>.</b> On-page SEO</p>
    <p align="left" style="color: white; opacity: .6;font-size: 22px"><b>.</b> With all the basic SEO benefits</p>

    <h2 align="left" style="color: white; "><u>Ultimate S E O</u></h2>
    <p align="left" style="color: white; opacity: .6;font-size: 22px"><b>.</b> Search Engine Submissions</p>
    <p align="left" style="color: white; opacity: .6;font-size: 22px"><b>.</b> Reports</p>
    <p align="left" style="color: white; opacity: .6;font-size: 22px"><b>.</b> Directory Submission</p>
    <p align="left" style="color: white; opacity: .6;font-size: 22px"><b>.</b> Local listings </p>
    <p align="left" style="color: white; opacity: .6;font-size: 22px"><b>.</b> With all the Premium SEO benefits</p>

    <p align="left" style="color: white; opacity: 1;font-size: 22px">Most top-ranking websites, the ones that appear "naturally" at the top of the search engine page just below the paid ads,
