...
<div class="navs">
    <ul>
        ...
        <div class="dv"></div>
        <li><a href="../portfolio" style=" opacity:1;color: rgb(140,140,140)"  >Portfolio</a></li>
...
<div style=" width: 90%; margin-left: 5%">
    ...
    <h3 align="left" style="color: white">Have a look at our mock ups below</h3>
    <p align="left" style="font-size: 20px;color: rgb(102,204,255); margin-bottom: -10px; margin-top: -10px">Book a Car</p>
    <p align="left" style="color: silver; margin-left: 20px">Car dealership</p>

    <div align="left" >
        <img src="../thumbnails/bac1.PNG" width="100%" >
    </div><br>
    <span class="opn" id="sp1" onclick="views1('sp1','dv1')">More</span><br><br>
    <div align="left" style="margin-left: 50px; display: none" id="dv1">
        <img src="../thumbnails/bac2.PNG" width="90%" style="float: left;" >
        <img src="../thumbnails/bac3.PNG" width="90%" style=" clear: left" >
    </div><br>

    <p align="left" style="font-size: 20px;color: rgb(102,204,255); margin-bottom: -10px; margin-top: -10px">DARK Sky (designs)</p>
    <p align="left" style="color: silver; margin-left: 20px">Furniture designs</p>
    <div align="left">
        <img src="../thumbnails/ds1.PNG" width="100%" >
    </div><br>
    <span class="opn" id="sp2" onclick="views2('sp2','dv2')">More</span><br><br>
    <div align="left" style="margin-left: 50px;display: none" id="dv2">
        <img src="../thumbnails/ds2.PNG" width="90%" style="float: left;" >
        <img src="../thumbnails/ds3.PNG" width="90%" style=" clear: left" >
    </div>
    <br>

    <p align="left" style="font-size: 20px;color: rgb(102,204,255); margin-bottom: -10px; margin-top: -10px">
        Rok the Construction</p>
    <p align="left" style="color: silver;">The Construction company</p>

    <div align="left">
        <img src="../thumbnails/rtc1.PNG" width="100%" >
    </div><br>
    <span class="opn" id="sp3" onclick="views3('sp3','dv3')">More</span><br><br>
    <div align="left" style="margin-left: 50px; display: none" id="dv3">
        <img src="../thumbnails/rtc2.PNG" width="90%" style="float: left;" >
        <img src="../thumbnails/rtc3.PNG" width="90%" style="clear: left" >
    </div>
