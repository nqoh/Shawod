...
<div  align="center" class="h_intro">
    <div align="center" class="intro_div">
        <span style="color: rgb(102,204,255); font-size: 30px">Getting Started !</span>
    </div>
</div>
<div style="width: 96%;">
    <div>
<p class="pack_name" style=" font-size: 30px"><b><u id="p_name"></u></b></p>

<p id="status" style=" font-size: 22px">

</p>

<div style="width:auto; margin-left:5%; height:auto; margin-top:0px;">
...
<div class="box_pack">
    ...
    <div  class="silver_box" style=" width: 100%; margin-left: -60%">
        ...
        <div class="silver_text">
            ...
            <span class="silver_p" id="prc" style="font-size: 22px"></span><br><br>
    ...
    <p class="add_status" align="center" style="font-size: 32px"><b><u>The following items are available upon request</u></b></p>
    <div align="center" style="margin-left: 5%">
        <p id="list" >
            <span id="state" style="font-size: 28px;"> Shopping Cart </span>
        </p>

        <p id="list" ">
            <span id="form" style="font-size: 28px;"> Multimedia Library </span>
        </p>

        <p id="list" >
            <span id="photo" style="font-size: 28px;"> Registration Form </span>
        </p>

        <p id="list" >
            <span id="photo" style="font-size: 28px;"> Payment Getway </span>
        </p>
    </div>

<p class="request" align="center" style="font-size: 32px;">
    <b><u>Additional features upon request after consulting</u></b>
</p>
<p class="assume_date" align="center">
    <span id="order" style="font-size: 24px;">
    </span>
<div id="t_div">
...
<p class="assume_date" align="center" style="margin-top: 2px">
    ...
    <span id="discount" style="font-size: 24px;"></span><br>
    <!--<span id="duration">Complete duration 1 to 5 weeks</span> -->
</p>

<div class="form" style="margin-left: 5%">
    <span class="fill_in" style="font-size: 24px;">Please fill out simple form and one of expect will get back at you</span><br>
    ...
    <input type="checkbox" id="accept" value="terms" style="margin-left: 20px;" checked="true"><span style="color: #e8f1ff;font-size: 22px;" id="ct">Accept our</span> <a href="../../terms" class="alink" style="font-size: 22px;" id="a">terms and conditions</a>
    <br>
