...
<div  align="center" class="h_intro">
    ...
    <p style="color:white; font-size: 22px">
        ...
        Please feel free <a href="http://shawod.co.za/contactus" class="alink">Contact us</a>  we will be more than happy to answer your Question.<br>
        Also refer to <a href="http://shawod.co.za/howitworks" class="alink">how it works</a> for more clarity.
    </p>
    <h3 align="left" style="color: white;font-size: 24px"><u>What is a domain name?</u></h3>
    <p align="left"  style="opacity: .8;color: white;font-size: 22px">A domain name is the actual name of a website (e.g. www.shawod.co.za), and every single website has a domain name.
    ...
    <h3 align="left" style=" color: white;font-size: 24px"><u>How much does a website cost?</u></h3>
    <p align="left"  style="opacity: .8;color: white;font-size: 22px">The cost of a website can vary depending on various
    ...
    <h3 align="left" style=" color: white;font-size: 24px"><u>I am totally new to this "website thing". How does the whole process work?</u></h3>
    <p align="left"  style="opacity: .8;color: white;font-size: 22px">Never fear, that's why we are here. Shawod is for people with little or no web development skills, other companies will design your website, not
    ...
    <h3 align="left" style=" color: white;font-size: 24px"><u>How long will it take to design my website?</u></h3>
    <p align="left"  style="opacity: .8;color: white;font-size: 22px">Currently our production schedule is 4 working days for a basic website, this time will vary from project to project.
        Projects may take from 1 to 6 weeks and this may also vary.</p>
    <h3 align="left" style=" color: white;font-size: 24px"><u>How does the payment process work?</u></h3>
    <p align="left"  style="opacity: .8;color: white;font-size: 22px">The project starts with a 50% deposit. After design sign off and before we move into programming, we collect 25%. Once we have completed
        and fulfilled our scope, the final 25% is collected and your website is then scheduled for launch.</p>
    <h3 align="left" style="color: white;font-size: 24px"><u>What kind of businesses do you work with?</u></h3>
    <p align="left"  style="opacity: .8;color: white;font-size: 22px">We work with a broad range of company types [small start-ups, large corporations, nonprofits, B2B, B2C and more] across many business industries [technology, food, apparel, health + beauty, camps, travel, finance, arts, fair trade, and more.]
    ...
    <h3 align="left" style="color: white;font-size: 24px"><u>How many changes can I make to my site without additional cost?</u></h3>
    <p align="left"  style="opacity: .8;color: white;font-size: 22px">We give as much latitude as we possibly can. After you've identified the general format and color schemes of your preferred design, we'll complete up to 2 rounds of major revisions at no charge. All minor revisions are provided at no charge.
    </p>
    <h3 align="left" style="color: white;font-size: 24px"><u>To begin creating our new website, what do you need?</u></h3>
    <p align="left"  style="opacity: .8;color: white;font-size: 22px">
    ...
    <h3 align="left" style="color: white;font-size: 24px"><u>Can I edit the Content on my website after you done?</u></h3>
    <p align="left"  style="opacity: .8;color: white;font-size: 22px">
    ...
    <h3 align="left" style=" color: white;font-size: 24px"><u>After our website is launched, who maintains it?</u></h3>
    <p align="left"  style="opacity: .8;color: white;font-size: 22px">
    ...
    <h3 align="left" style="color: white;font-size: 24px"><u>What other Services do you offer?</u></h3>
    <p align="left"  style="opacity: .8;color: white;font-size: 22px">We offer Web designing, Company Logo Designs, Web Hosting, Google Local Optimization,<a class="alink" href="../seo"> SEO</a> and more.</p>
    <h3 align="left" style=" color: white;font-size: 24px"><u>What is Web Hosting?</u></h3>
    <p align="left"  style="opacity: .8;color: white;font-size: 22px">
    ...
    <h3 align="left" style="color: white;font-size: 24px"><u>Can I buy web hosting without a domain name?</u></h3>
    <p align="left"  style="opacity: .8;color: white;font-size: 22px">
    ...
    <h3 align="left" style="color: white;font-size: 24px"><u>What is disk space and how much do I need?</u></h3>
    <p align="left"  style="opacity: .8;color: white;font-size: 22px">
    ...
    <h3 align="left" style="color: white;font-size: 24px"><u>How do I obtain a dedicated email account? (me@mywebsite.com)</u></h3>
    <p align="left"  style="opacity: .8;color: white;font-size: 22px">
    ...
    <h3 align="left" style="color: white;font-size: 24px"><u>How will I know how many people visited my site?</u></h3>
    <p align="left"  style="opacity: .8;color: white;font-size: 22px">
