...
/*var_dump(datediffInWeeks('4/1/2019', '5/6/2019')); exit();*/
...
$yearEnd=substr($row['project_end'],0,4);
$montEnd=substr($row['project_end'],5,2);
$dateEnd=substr($row['project_end'],8,2);


$yearStart=substr($row['date'],0,4);
$montStart=substr($row['date'],5,2);
$dateStaet=substr($row['date'],8,2);
?>
<!DOCTYPE html>
<html>
<head>
                ...
                <div class="mbr-section row">
                    ...
                    <div class="mbr-table-md-up">
                        ...
                        <div class="mbr-section-text">
                            <p>Please visit again soon your project is under construction.<br>Duration <strong>1 - <?php echo  datediffInWeeks("$montStart/$dateStaet/$yearStart", "$montEnd/$dateEnd/$yearEnd"); ?></strong> <strong>weeks</strong></p>
                        </div>
