...
function close_ticker(c,p,r,p_m,id,dp,img) {
    ...
    localStorage.setItem("departments",dp);
}
function canceling() {
...
function deleted() {
    ...
    ajax.send("my_id="+localStorage.myid+"&department="+localStorage.departments);
}
...
_("m").style.color="rgb(153,153,153)";_("cm").style.color="black";_("notify").style.display="none";_("nt").style.color="black"}
