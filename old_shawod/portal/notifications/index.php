...
if(isset($_SESSION['id']) && isset($_SESSION['uname'])){
    ...
    if(mysqli_num_rows($quey)==1){
        ...
        $query=mysqli_query($conn,"UPDATE notifications set `view`=0 WHERE f_key='$ids'  ");
    }else{
...
<div class="wrap">
    ...
    <div class="sid_nav">
        <ul>
            ...
            <li class="bg" ><a href="../notifications" style="color:white">Notifications</a></li>
    ...
    <div style="width:1300px;padding-left:35px;padding-top:110px;">
        <div class="content">
            <h1 id="top" align="center" style="margin-left: 120px;" >Notifications</h1>
            ...
            <div id="preview">
                ...
                $notify='';
                $id=$_SESSION['id'];
                $q=mysqli_query($conn,"SELECT * FROM notifications WHERE f_key='$id' ORDER BY id DESC");
