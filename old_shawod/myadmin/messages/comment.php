...
if(isset($_POST['project']) && isset($_POST['message'])){
   ...
   if($_POST['project']=='web'){
      ...
      mysqli_query($conn,"INSERT INTO `comment` VALUES(NULL ,'$msg','','','$myid',0,1,'$dt')");
      echo $_POST['message'];
      exit();
...
// This div is for website and comment form
    ...
    $webst = "<div  style=\"display:none\" id=\"prev1\">$prev</div><p style=\"margin-left:40px;margin-bottom:-35px;font-size:13px; color:rgb(109,109,109)\"> $tm1 </p><br>
