...
if ($tablet_browser > 0) {
    ...
    header('Location: https://mobi.shawod.co.za/hosting');
    exit();
}
else if ($mobile_browser > 0) {
    // do something for mobile devices

    header('Location: https://m.shawod.co.za/hosting');
    exit();
...
<head>
    <meta charset="UTF-8">
    <title id="title">Hosting | Shawod</title>
                     <meta http-equiv="X-UA-Compatible" content="IE=edge" />
   <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
   <meta name="viewport" content="width=device-width, initial-scale=1" />
    <meta name="description" content="Shawod is also a web hosting service provider, we provide the technologies and services needed for website or webpage to be viewed in the inernet.">
...
<meta property="og:url" content="http://shawod.co.za/hosting">
<meta property="og:title" content="Hosting | Shawod">
<meta property="og:description" content="Shawod is also a web hosting service provider, we provide the technologies and services needed for website or webpage to be viewed in the inernet.">
<meta property="og:image" content="http://shawod.co.za/thumbnails/shawodTro.jpg">
<meta property="twitter:url" content="http://shawod.co.za/hosting">
<meta property="twitter:title" content="Hosting | Shawod">
<meta property="twitter:description" content="Shawod is also a web hosting service provider, we provide the technologies and services needed for website or webpage to be viewed in the inernet.">
...
<link rel="icon" type="image/ico" href="../thumbnails/logoSb.png">
...
<div  align="center" class="h_intro">
    <div align="center" class="intro_div">
        <span style="color: rgb(102,204,255)">Hosting</span>
    </div>
    <p align="center" style="color:white;font-size: 18px">Shawod is also a web hosting service provider, we provide the technologies and services needed for website
        or webpage to be viewed in the inernet.<br> Websites are hosted on special computers called servers. forward your enquiries to info@shawod.co.za
    </p>
    <img src="../thumbnails/hostngs.png" style="width: 1000px">
</div>
<br><br><br>
