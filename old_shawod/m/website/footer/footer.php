...
<div class="footer_links" style="width: 102%;height: 80px; background-color: rgb(51,51,51)">
    ...
    <map name="four">
        <span style="color: rgb(255,255,255);margin-left:-20%;  font-size: 16px; margin-top:15%">Follow us on</span>
        <area shape="rect"  coords="5,0,26,14" alt="Like Shawod" href="hhttps://www.facebook.com/shawodza">
        <area shape="rect" coords="40,0,72,14" alt="follow Shawod" href="http://www.twitter.com/mp3olova">
    </map>

    <div style="width:5%; height:20px;float:left; padding-left:20%; margin-top:55px; margin-left:-110px;">
        <a href="../blog" style="color:white; text-align:center; text-decoration:none">Blog</a>

    </div>
    <div  class="link_footer2" style="float: right; margin-top: 4%;">
...
<div class="footer_copy" style="width: 90%; height: auto; background-color: rgb(102,102,102)">
