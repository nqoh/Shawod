...
<div class="navs">
 ...
 <div class="slide_div"  align="center" >
     <img src="../thumbnails/slide1.png" id="img">
<br><br>
 </div>
...
<div class="web_pp" align="center">
    ...
    <div id="maintenances" >
        <img src="../thumbnails/modern.png" style="width: 120px">
    ...
    <div id="upt" >
        <img src="../thumbnails/userfr.png" style="width: 120px" >
    ...
    <div id="cost_e">
        <img src="../thumbnails/seo.png" style="width: 120px">
...
<a href="../website" style="color: rgb(102,240,255); text-decoration: none; font-weight: bold; margin-left: 5%">More on website > </a><br><br>
 ...
 <div class="web_pp" align="center">
    ...
    <div id="maintenances">
        <img src="../thumbnails/maintainancefree.png" style="width: 130px">
    ...
    <div id="upt">
        <img src="../thumbnails/uptime.png" style="width: 130px" >
    ...
    <div id="cost_e" >
        <img src="../thumbnails/dedcost.png" style="width: 130px">
...
<div class="web_pp" align="center">
    ...
    <div id="maintenances">
        <img src="../thumbnails/cms.png" style="width: 130px">
    ...
    <div id="upt">
        <img src="../thumbnails/smigration.png" style="width: 130px" >
    ...
    <div id="cost_e" >
        <img src="../thumbnails/worldwide.png" style="width: 130px">
        <p style="color:white"><b>S.E.O</b></p>
        <p  class="money_text">
...
<h3 style="color:rgb(255,255,255); margin-left: 50px; width: 90.2%"><u>Welcome to Shawod where your imagination becomes a reality</u></h3>

 <p style="color:rgb(255,255,255); margin-left: 5%; width: 90%; margin-top: -8px; font-size: 17px">Imagine your business or organization operating more efficiently than ever.
 ...
 <h1 align="center" style="color:rgb(102, 204, 255); margin-left: 5%; width: 90%;" class="why">Why choose us ?</h1>

<div style="margin: 0px auto; width: 90%;"  class="images"><img src="../thumbnails/why-us-blue4.gif" ></div>


 <p style="color:rgb(255,255,255); width: 91.2%; margin-left: 5%; font-size:17px;"  align="center">Shawod serves as a resource to people with little or no web development
