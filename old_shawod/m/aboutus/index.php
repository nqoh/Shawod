...
<div style="margin-left: 5%">
 ...
 <img src="../thumbnails/logW.png" style="margin-left: 35%; margin-top: -3%; margin-bottom: -5%" >

        <div align="center"  style="font-family: Stencil; font-size: 22px; color: white; width: 90%">
            Let's make your <span style="color: rgb(102,204,255); ">Online Brand Ambassador !</span>
        </div>
    <div style="width: 90%">
    <p style="color: white; ">Shawod is a small but capable Internet consulting company, we help our clients
        meet their goals using the most functional, state-of-the-art, and exciting Internet tools available..</p>

    <p style="color: white;"> Shawod serves as a resource to people with little or no web development skills to quickly
