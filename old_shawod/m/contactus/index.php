...
<div  style="width: 90%; margin-left: 5%;">
    ...
    <form class="form" method="post" action="../contactus/index.php">
        ...
        <input type="text" class="text-field3" id="namee" name="namee" onblur="name_out('namee','namee_error')" onfocus="mouse_in('namee')"><br>

        <br><label class="lebel">E-mail<span style="color:red"> * </span></label><span id="emaile_error" style="color: red"></span><br>

        <input type="text" class="text-field3" name="emaile" onblur="check_email('emaile','emaile_error')" onfocus="mouse_in('emaile')" ><br>

        <br><label class="lebel">Subject</label>&nbsp;&nbsp;<span id="sub_error" style="color: red"></span><br>
        <input type="text" class="text-field3" id="subjs" name="sub" onblur="subj('subjs','sub_error')"  onfocus="mouse_in('subjs') "><br>

        <br><label class="lebel">Query<span style="color:red"> * </span></label><span style="color: red" id="describes_error"></span><br>

    <textarea style=" border: 1px solid #ccc;" name="txt"  id="textarea" onblur="texts('textareas','describes_error')" onfocus="mouse_in('textareas')" ></textarea>
