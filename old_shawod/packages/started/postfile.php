...
<div style="background: rgb(79,79,79); width: 830px; height: 130px">

<span  style="font-size: 50px; text-align:center; margin-left:110px; color: rgb(73,197,239)">Thank Your For Your Order!</span><br>
<span align="center" style="font-size: 20px; text-align:center; margin-left: 200px;color: rgb(73,197,239)">ORDER CONFIRMATION FROM SHAWOD.CO.ZA</span></div>

<div style="margin-top: 5px; background-color: white;width: 810px;padding: 10px ">
