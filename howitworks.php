...
<head>
    ...
    <title>How it works | Shawod</title>
...
<meta name="title" content="How it works | Shawod">
...
<meta name="robots" content="index/follow">
    ...
    <meta property="og:url" content="https://shawod.co.za/howitworks.php">
...
<meta property="twitter:url" content="https://shawod.co.za/howitworks.php">
                ...
                <div class="row">
                    <div class="action">
                        <div class="col-sm-12">
                            ...
                            <p>Know the process.&nbsp;<i class="fa fa-info-circle" ></i></p>
                        </div>
                     </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="clients text-left wow fadeInUp" data-wow-duration="500ms" data-wow-delay="300ms">
                        ...
                        <b>Step 2 :</b> After approval, We send you our<a href="portal/index.php"> Clients Portal </a> link and Login credentials.<br><br>
...
<p> <b>Step 5 :</b>  Site Launched!<br>
    Your website is launched live to the world and submitted to the search engines (if purchaced). Congratulations on a successful launch with Shawod. </p>
                        ...
                        <br><br>
                        <p>Also refer to our <a href="faq"> Frequently Asked Questions</a></p>
                    </div>
                </div>
            </div>
        </div>
