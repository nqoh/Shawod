...
<meta name="title" content="Portfolio | Shawod">
...
<meta name="robots" content="index/follow">
    ...
    <meta property="og:url" content="https://shawod.co.za/portfolio.php">
...
<meta property="twitter:url" content="https://shawod.co.za/portfolio.php">
                ...
                <div class="row">
                    <div class="action">
                        <div class="col-sm-12">
                            ...
                            <p>Our pillars of strength. &nbsp;<i class="fa fa-heartbeat" ></i></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="clients text-center wow fadeInUp" data-wow-duration="500ms" data-wow-delay="300ms">
                        <h1> Join our <a href="#" class="typewrite" data-period="100000" data-type='[ "Happy", "Satisfied" ]'>
    <span class="wrap"></span>
            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <img src="images/portfolio-details/1.jpg" class="img-responsive" alt=""></div>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="live-preview">
                        <!--<a href="http://intermasiko.com"  target="_blank" class="btn btn-common uppercase">Live preview</a>-->
                ...
                <div class="row">
                    <div class="action take-tour">
                        <div class="col-sm-7 wow fadeInLeft" data-wow-duration="500ms" data-wow-delay="300ms">
                            <h1 class="title">Become our happy client</h1>
                            <p>Select your desired package now.</p>
                        </div>
                        <div class="col-sm-5 text-center wow fadeInRight" data-wow-duration="500ms" data-wow-delay="300ms">
                            <div class="tour-button">
                                <div class="wraps"> <a class="btn-6" href="packages">VIEW OUR DEALS<span></span></a></div>
                             </div>
                        </div>
                    </div>
                </div>
    ...
    <section id="clients">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <div class="clients text-center wow fadeInUp" data-wow-duration="500ms" data-wow-delay="300ms">
                        <p><img src="images/portfolio/shasha.png" class="img-responsive" alt=""></p> <br>
