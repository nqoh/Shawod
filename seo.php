...
<head>
    ...
    <style type="text/css"> .single-service, .single-service-2, .single-service-3 {margin: 15px 0; margin-right: 50px;} </style>
                ...
                <div class="row">
                    <div class="action">
                        <div class="col-sm-12">
                            ...
                            <p>Be visible online. &nbsp; <i class="fa fa-search" ></i></p>
                        </div>
                     </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="clients text-center wow fadeInUp" data-wow-duration="500ms" data-wow-delay="300ms">
                        <p><img src="images/home/image3.png" class="img-responsive" alt=""></p>
                        <h1 class="title">S E O</h1>
                        <p>SEO is the process of optimizing your website and online presence in order for search engines (e.g. Google, Bing) to rank your website organically. <br> What does organic or natural rankings mean? It means that Google will look at your website and online profile and decide for which keywords they will rank you on the first page of the search engine results
 <br><br> The consultants at Shawod are search engine optimization experts. We can help your site achieve top rankings on major search engines by implementing our thorough, common sense methodology.</p>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="action take-tour">
                        <div class="col-sm-7 wow fadeInLeft" data-wow-duration="500ms" data-wow-delay="300ms">
                            ...
                            <p>Select your desired SEO package now.</p>
                        </div>
                        <div class="col-sm-5 text-center wow fadeInRight" data-wow-duration="500ms" data-wow-delay="300ms">
                            <div class="tour-button">

                                <!--<a href="./packages.html" class="btn btn-common">VIEW OUR DEALS</a>-->
