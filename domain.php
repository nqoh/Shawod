...
<meta name="title" content="Domain | Shawod">
...
<meta name="robots" content="index/follow">
    ...
    <meta property="og:url" content="https://shawod.co.za/domain.php">
...
<meta property="twitter:url" content="https://shawod.co.za/domain.php">
                ...
                <div class="row">
                    <div class="action">
                        <div class="col-sm-12">
                            ...
                            <p>Get your website address. &nbsp; <i class="fa fa-link" ></i></p>
                        </div>
                     </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="clients text-center wow fadeInUp" data-wow-duration="500ms" data-wow-delay="300ms">
                        <p><img src="images/home/domaincs.png" class="img-responsive" alt=""></p> <br>
                        <h1 class="title">Domain</h1>
                        <p>Shawod Domain Name Search tool can instantly find the domain name that you've been looking for, simple domain set up - no technical skills needed. forward your enquiries to info@shawod.co.za
</p>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="action take-tour">
                        <div class="col-sm-7 wow fadeInLeft" data-wow-duration="500ms" data-wow-delay="300ms">
                            <h1 class="title">Shawod Domains</h1>
                            <p>Self managed domains are not yet available, we however get one for you on one of our Registrar partners if you purchase a package.</p>
                        </div>
